...
export type LibrarySection = 'dictionary' | 'concepts' | 'quality-domains' | 'quality-dimensions'

export const VALID_TABS: SidebarView[] = ['scene', 'import-export', 'library']

export const VALID_LIBRARY_SECTIONS: LibrarySection[] = ['dictionary', 'concepts', 'quality-domains', 'quality-dimensions']
